...
#' \item{6.} \code{pre_tpx_count}: Number of pre-STSC transplantation. Source: \code{Patient}.
#' \item{7.} \code{pre_organ_count}: Number of pre-STSC organ. Source: \code{Patient}.
#' \item{8.} \code{weight}: Weight of patient at enrollment. Source: \code{PatientLongitudinal}.
#' \item{9.} \code{height}: Height of patient at enrollment. Source: \code{PatientLongitudinal}.
#' \item{10.-24.} \code{hla...}: (Optional) Patient HLA. Source: \code{PatientHLA}.
#' }
#'
#'@name tailored_table
#'@export
tailored_patientbl <- function(stcs){
  ...
  out <-
    stcs[["patient"]] |>
    select(all_of(c("patientkey","patid","enrollment_age","sex","bg","pre_tpx_count","pre_organ_count"))) |>
    left_join(
